...
if ($_smarty_tpl->tpl_vars['renter']->value['status'] == 1) {?><div class="vystavlenie-schetov-item"><label class="container-checkbox"><?php echo $_smarty_tpl->tpl_vars['renter']->value['full_name'];?>
...
"><span class="checkmark"></span></label><label class="period-sum" for="period_sum">сумма:</label><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['renter']->value['summa'];?>
" name="period_sum" style="width: 130px; color: gray; border: none; border-bottom: 1px solid #f95252; padding-left: 5px;"></div><?php }
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?><p class="vystavlenie-schetov-hidden-btn">Показать с недействующими договорами</p><div class="vystavlenie-schetov-hidden"><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['renters']->value, 'renter');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['renter']->value) {
if ($_smarty_tpl->tpl_vars['renter']->value['status'] == 0) {?><div class="vystavlenie-schetov-item"><label class="container-checkbox"><?php echo $_smarty_tpl->tpl_vars['renter']->value['full_name'];?>
 - <?php echo $_smarty_tpl->tpl_vars['renter']->value['contract_number'];?>
<input type="checkbox" name="renter" value="<?php echo $_smarty_tpl->tpl_vars['renter']->value['renter_id'];?>
"><span class="checkmark"></span></label><label class="period-sum" for="period_sum">сумма:</label><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['renter']->value['summa'];?>
" name="period_sum" style="width: 130px; color: gray; border: none; border-bottom: 1px solid #f95252; padding-left: 5px;"></div><?php }
