...
"></td></tr><?php if ($_smarty_tpl->tpl_vars['disc']->value == 1) {?><tr><td style="text-align: right; font-weight: bold; border: none;">Скидка:</td><td style="width: 90px; border: 1px solid #000000; border-top: none;"><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['discount_summ']->value;?>
...
"></td></tr></table><table style="widht: 200px; float: right;"><tr><td style="text-align: right; font-weight: bold; border: none;">Итого:</td><td style="width: 90px; border: 1px solid #000000; border-top: none;"><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['print']->value['invoice_summa'];?>
"></td></tr><?php if ($_smarty_tpl->tpl_vars['disc']->value == 1) {?><tr><td style="text-align: right; font-weight: bold; border: none;">Скидка:</td><td style="width: 90px; border: 1px solid #000000; border-top: none;"><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['discount_summ']->value;?>
"></td></tr><?php }?><tr><td style="text-align: right; font-weight: bold; border: none;">Без налога (НДС).</td><td style="border: 1px solid #000000;">-</td></tr><?php if ($_smarty_tpl->tpl_vars['disc']->value == 1) {?><tr><td style="text-align: right; font-weight: bold; border: none;">Всего:</td><td style="border: 1px solid #000000;"><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['print']->value['discoint'];?>
...
"></td></tr><?php }?></table><div style="clear: both;"></div><div class="podval"><?php if ($_smarty_tpl->tpl_vars['disc']->value == 1) {?><p style="font-style: italic; font-size: 12px;">Всего оказано услуг на сумму<strong><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['print']->value['contract_summa_string'];?>
...
"></td><?php }?><td>без акциза</td><td>без НДС</td><td>без НДС</td><?php if ($_smarty_tpl->tpl_vars['disc']->value == 1) {?><td><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['print']->value['discoint'];?>
"></td><?php } else { ?><td><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['print']->value['invoice_summa'];?>
"></td><?php }?><td></td><td></td><td></td></tr><tr><td colspan="6" style="text-transform: uppercase;"><strong>Всего к оплате:</strong></td><?php if ($_smarty_tpl->tpl_vars['disc']->value == 1) {?><td><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['print']->value['discoint'];?>
"></td><?php } else { ?><td><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['print']->value['invoice_summa'];?>
"></td><?php }?><td colspan="2">X</td><td>без НДС</td><?php if ($_smarty_tpl->tpl_vars['disc']->value == 1) {?><td><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['print']->value['discoint'];?>
"></td><?php } else { ?><td><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['print']->value['invoice_summa'];?>
