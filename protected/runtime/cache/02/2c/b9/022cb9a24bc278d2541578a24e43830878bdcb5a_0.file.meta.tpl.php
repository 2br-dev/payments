...
function content_5c0e439c775063_06561671 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
"><?php }?><!-- CSS --><link type="text/css" rel="stylesheet" href="/css/normalize.css" ><link type="text/css" rel="stylesheet" href="/css/style.css" ><?php if ($_smarty_tpl->tpl_vars['uri']->value[0] == 'pechat-aktov-schetov') {?><link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" /><?php }?><link rel="icon" href="/img/favicon.png" type="image/x-icon"></head><body class="page-<?php echo $_smarty_tpl->tpl_vars['_page']->value['system'];?>
"><?php }
}
