...
<div class="vote-container">
  ...
  <div class="vote-young">
    <div class='vote-item vote-young-item'>
      ...
      <div class="vote-text">
        ...
        {if $smarty.cookies.vote_young == 'voted'}
          <p class="vote-result">Количество голосов: {$result_young_1}</p>
        {else}
    ...
    <div class='vote-item vote-young-item'>
      ...
      <div class="vote-text">
        ...
        {if $smarty.cookies.vote_young == 'voted'}
          <p class="vote-result">Количество голосов: {$result_young_2}</p>
        {else}
    ...
    <div class='vote-item vote-young-item'>
      ...
      <div class="vote-text">
        ...
        {if $smarty.cookies.vote_young == 'voted'}
          <p class="vote-result">Количество голосов: {$result_young_3}</p>
        {else}
    ...
    <div class='vote-item vote-young-item'>
      ...
      <div class="vote-text">
        ...
        {if $smarty.cookies.vote_young == 'voted'}
          <p class="vote-result">Количество голосов: {$result_young_4}</p>
        {else}
    ...
    <div class='vote-item vote-young-item'>
      ...
      <div class="vote-text">
        ...
        {if $smarty.cookies.vote_young == 'voted'}
          <p class="vote-result">Количество голосов: {$result_young_5}</p>
        {else}
    ...
    <div class='vote-item vote-young-item'>
      ...
      <div class="vote-text">
        ...
        {if $smarty.cookies.vote_young == 'voted'}
          <p class="vote-result">Количество голосов: {$result_young_6}</p>
        {else}
  ...
  <div class="vote-old">
    <div class='vote-item vote-old-item'>
      ...
      <div class="vote-text">
        <p class="vote-number">№ 1</p>
        {if $smarty.cookies.vote_old == 'voted'}
          <p class="vote-result">Количество голосов: {$result_old_1}</p>
        {else}
    ...
    <div class='vote-item vote-old-item'>
      ...
      <div class="vote-text">
        <p class="vote-number">№ 2</p>
        {if $smarty.cookies.vote_old == 'voted'}
          <p class="vote-result">Количество голосов: {$result_old_2}</p>
        {else}
    ...
    <div class='vote-item vote-old-item'>
      ...
      <div class="vote-text">
        <p class="vote-number">№ 3</p>
        {if $smarty.cookies.vote_old == 'voted'}
          <p class="vote-result">Количество голосов: {$result_old_3}</p>
        {else}
    ...
    <div class='vote-item vote-old-item'>
      ...
      <div class="vote-text">
        <p class="vote-number">№ 4</p>
        {if $smarty.cookies.vote_old == 'voted'}
          <p class="vote-result">Количество голосов: {$result_old_4}</p>
        {else}
    ...
    <div class='vote-item vote-old-item'>
      ...
      <div class="vote-text">
        <p class="vote-number">№ 5</p>
        {if $smarty.cookies.vote_old == 'voted'}
          <p class="vote-result">Количество голосов: {$result_old_5}</p>
        {else}
    ...
    <div class='vote-item vote-old-item'>
      ...
      <div class="vote-text">
        <p class="vote-number">№ 6</p>
        {if $smarty.cookies.vote_old == 'voted'}
          <p class="vote-result">Количество голосов: {$result_old_6}</p>
        {else}
...
{/strip}
  ...
  {* ТУТ ПОДКЛЮЧАЮ ЕЩЁ JQUERY И SIMPLE LIGHTBOX*}
  <script src="/static/js/jquery.min.js"></script>
  <script src="/konkurs/simplelightbox-master/dist/simple-lightbox.min.js"></script> 
  {* еще нужно подключить CSS FILE лайтбокса  *}
